    ...
    <div class="container-fluid">
        ...
        <!-- Form log in -->
            <div class="col-lg-3 col-md-12" id="form_infor" style="height: 100%; margin-top:100px;">
                <h4 style="padding-left: 15px;"> Log In </h4>
                <form action="login.php" method="POST">
                    <input type="text" placeholder="Username" id="username" name="username" aria-label="Name" require>
                    <input type="password" placeholder="Password" id="password" name="password" aria-label="Password" require>
                    <?php
                    if ($status == 'login false') {
                        echo "<label for=\"\" style=\"color: red;\">sai tên đăng nhập hoặc mật khẩu</label > <br>";
                    }
                    ?>
                    ...
                    <p style="margin-left: 40px;"> Don't have an account? </p>       
